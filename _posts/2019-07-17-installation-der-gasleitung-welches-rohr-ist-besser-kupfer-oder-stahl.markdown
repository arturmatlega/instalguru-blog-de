...
photo_desc: Gasinstallationen können aus Stahlrohren bestehen, obwohl auch Kupferrohre
  verwendet werden.
faq:
- question: Wie lötet man Kupferrohre?
  answer: Wenn Sie kein Fachmann sind, versuchen Sie nicht, eine Gasleitung zu löten.
    Es ist am besten, einen Spezialisten einzustellen, der dies schnell und sicher
    erledigt.
- question: Wie verbindet man PVC-Rohre?
  answer: Sie können einen PVC-Schlauch durch Kleben anschließen. Decken Sie die Enden
    der beiden Elemente mit Klebstoff ab und tragen Sie dann Klebstoff auf. Dies ist
    eine sehr einfache Methode, ein PVC-Rohr zu verbinden.
- question: Wie lange halten Kupferrohre?
  answer: Kupferrohre halten in der Regel etwa 20 Jahre. Bei ordnungsgemäßer Wartung
    kann diese Art von Rohrleitungsmaterial bis zu 50 Jahre halten - in einigen Fällen
    sogar noch länger.
- question: Was sind PVC-Rohre?
  answer: Die Abkürzung PVC steht für Polyvinylchlorid. In letzter Zeit ist es üblich,
    in Wasserinstallationen Metallrohre durch PVC-Rohre zu ersetzen.
